...
Beautiful passing green specs, easy to read failing red specs, a clickable backtrace and the failing spec for good measure.

Pretty sweet right? Let me show you how to get started.
...
If you act now, we'll throw in a <a href="http://github.com/jqr/thor_tasks/raw/master/rspec_rename_to_dotspec.thor">fancy converter</a> for all your old specs!
